                    ...
                    {sampling_info !== undefined && <div>
                        ...
                        <ul class="dropdown-content">
                            {(UserType === 1 || UserType === 2 || UserType === 3) && (<span>
                                <li className='dropdown-link' onClick={() => navigate('/h2s_survey')}>Household</li>
                            </span>)}
                            {(UserType === 2 || UserType === 3) && (<span>
                                <li className='dropdown-link' onClick={() => navigate('/fib_analysis')}>Intermidiate</li>
                            </span>)}
                            {(UserType === 3) && (<span>
                                <li className='dropdown-link' onClick={() => navigate('/mst')}>Expert</li>
                            </span>)}
                        </ul>
                    </div>}
                </div>
