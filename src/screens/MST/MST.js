...
const MST = () => {
  ...
  const [selectedMST, setselectedMST] = useState('Select a Marker');
...
<div className='group-mst'>
                  ...
                  <div className='form-group'>
                    ...
                    {BestFitModel === 'beta-poisson' && <span>
                      <label><input  className='form-input w-75' type='text' placeholder='Alpha' onChange={(event) => setAlpha(event.target.value)} /></label>
                      <label> Beta
