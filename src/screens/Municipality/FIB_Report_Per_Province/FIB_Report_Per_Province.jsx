...
function FIB_Report_Per_Province(){
    ...
    useEffect(() => {
        ...
        //get_fib_by_province
        axios.get(api + 'fib_province').then(respond => {
    ...
    function h2s_province(province_id) {
        axios.get(api + 'fib_municipality/' + province_id).then(respond => {
    ...
    function h2s_results(municipal_id) {
        ...
        axios.get(api + 'fib_risk_results/' + municipal_id).then(respond => {
